...
Detailed reference material is available in the [awesome-copilot aspire skill](https://github.com/github/awesome-copilot/tree/main/skills/aspire/references) — load on demand.
...
|---|---|
| [CLI Reference](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/cli-reference.md) | Command flags, options, or detailed usage |
| [MCP Server](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/mcp-server.md) | Setting up MCP for AI assistants, available tools |
| [Integrations Catalog](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/integrations-catalog.md) | Discovering integrations via MCP tools, wiring patterns |
| [Polyglot APIs](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/polyglot-apis.md) | Method signatures, chaining options, language-specific patterns |
| [Architecture](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/architecture.md) | DCP internals, resource model, service discovery, networking, telemetry |
| [Dashboard](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/dashboard.md) | Dashboard features, standalone mode, GenAI Visualizer |
| [Deployment](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/deployment.md) | Docker, Kubernetes, Azure Container Apps, App Service |
| [Testing](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/testing.md) | Integration tests against the AppHost |
| [Troubleshooting](https://github.com/github/awesome-copilot/blob/main/skills/aspire/references/troubleshooting.md) | Diagnostic codes, common errors, and fixes |
...
### Service Control (DataNative pattern)

```csharp
// Conditional service enablement via configuration
var enableService = builder.Configuration.GetValue<bool>("Services:EnableMyService", true);
if (enableService)
{
    var myService = builder.AddProject<Projects.DataNative_MyService>("myservice")
        .WithReference(apiService);
    Console.WriteLine("Registered: My Service");
}
```
